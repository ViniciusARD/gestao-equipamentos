...
from app.routes import auth, equipments, reservations, admin, users, google_auth, two_factor_auth, setores # <-- IMPORTAR
...
app.include_router(setores.router) # <-- ADICIONAR
